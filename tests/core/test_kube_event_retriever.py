...
class TestKubeEventRetriever(KubeTestCase):
    ...
    def test_events_resversion_filtering(self):
        jsons = self._load_json_array(['service_cache_events1.json', 'service_cache_events2.json', 'service_cache_events2.json'])
    ...
    def test_kind_serverside_filtering(self):
        ...
        mock_method.assert_called_once_with('https://kubernetes/api/v1/events', params={'fieldSelector': 'involvedObject.kind=k1'})

    def test_kins_clientside_filtering(self):
